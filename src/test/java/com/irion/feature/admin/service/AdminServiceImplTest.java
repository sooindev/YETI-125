...
import com.irion.feature.admin.persistence.AdminMapper;
import com.irion.feature.admin.service.impl.AdminServiceImpl;
import com.irion.feature.admin.domain.AdminVO;
import com.irion.common.security.PasswordUtil;
...
public class AdminServiceImplTest {
    ...
    /** 옛 형식 해시는 로그인 불가 — 그런 백업은 해시 재발급 필요 */
    @Test
    ...
    /** EXISTING_ID 만 아는 가짜 매퍼를 꽂은 서비스 */
